...
10진수의 리터럴은 맨 앞이 **'0'이 아닌 숫자**로 이루어져있다. 숫자 0~9까지 포함할 수 있다.  
2진수의 리터럴은 맨 앞이 **'0b (0B)'**로 이루어진 숫자 데이터이다. 2진수는 오직 숫자 0과, 1만 포함할 수 있다.  
8진수의 리터럴은 맨 앞이 **'0o (0O)'**로 이루어진 숫자 데이터이다. 8진수는 숫자 0~7을 포함할 수 있다.  
16진수의 리터럴은 맨 앞이 **'0x (0X)'**로 이루어진 숫자 데이터이다. 16진수는 숫자 0~9, 문자 a~f를 포함할 수 있다.
```js
var dec = 10;			// 10진수 10
...
---
|[prev](./03-variable.ko_KR.md)|[content](./00-contents.ko_KR.md)|next|
|:--:|:--:|:--:|